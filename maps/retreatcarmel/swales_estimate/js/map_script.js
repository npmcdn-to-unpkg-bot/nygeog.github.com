var map;
      ...
      //}).addTo(map);
      L.tileLayer('http://{s}.basemaps.cartocdn.com/nokia/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, &copy; <a href="http://cartodb.com/attributions">CartoDB</a>'
        }).addTo(map);

    
      var layerUrl = "https://nygeog.cartodb.com/api/v2/viz/edc1b624-329c-11e6-a380-0ecfd53eb7d3/viz.json";
